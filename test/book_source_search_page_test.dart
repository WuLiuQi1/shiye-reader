...
void main() {
  ...
  test('normalizes punctuation and ranks exact book titles first', () {
    ...
    const unrelated = BookSourceBook(
      id: '2',
      title: '其他小说',
      author: '作者',
      description: '',
    ...
    expect(SourceSearchPage.relevanceScore(exact, '极品家丁'), 100);
    expect(SourceSearchPage.relevanceScore(unrelated, '极品家丁'), 0);
  });
