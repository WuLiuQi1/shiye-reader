...
class BookSourceClient {
  ...
  late final LegadoRuleClient _legadoClient = LegadoRuleClient(dio: _dio);
  ...
  Future<List<BookSourceChapter>> getChapters(
    ...
    if (source.legadoConfig != null) {
      return _legadoClient.getChapters(source, bookId);
    }
  ...
  Future<BookSourceChapterContent> getChapterContent(
    ...
    if (source.legadoConfig != null) {
      return _chapterCache.getOrLoad(
        ...
        bookId: bookId,
        chapterId: chapterId,
        loader: () => _legadoClient.getChapterContent(
          source,
          bookId: bookId,
          chapterId: chapterId,
        ),
  ...
  Future<BookSourceChapterContent> getChapterContentForDownload(
    ...
    if (source.legadoConfig != null) {
      cancellation?.throwIfCancelled();
      return _legadoClient.getChapterContent(
        source,
        bookId: bookId,
        chapterId: chapterId,
      );
