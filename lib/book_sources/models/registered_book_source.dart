...
class RegisteredBookSource {
  ...
  final Map<String, dynamic>? legadoConfig;
  ...
  factory RegisteredBookSource.fromJson(Map<String, dynamic> json) {
    return RegisteredBookSource(
      ...
      legadoConfig: json['legadoConfig'] is Map
          ? Map<String, dynamic>.from(json['legadoConfig'] as Map)
          : null,
    );
  }
  ...
  Map<String, dynamic> toJson() => {
    ...
    if (legadoConfig != null) 'legadoConfig': legadoConfig,
    'enabled': enabled,
